...
def test_registry_preserves_formal_decisions_and_evidence_boundaries() -> None:
    ...
    assert experiments["rars_v9_locked_confirmation"]["evidence_tier"] == "preregistered_not_yet_run"
...
def test_registry_does_not_upgrade_v8_or_v9_to_independent_evidence() -> None:
    ...
    assert "not independent" in experiments["rars_v9_locked_confirmation"]["lesson"]
