#!/usr/bin/env python3
"""Pure numerical core for the RARS-v16 causal-generalization protocol.
...
DEFAULT_CAUSAL_THRESHOLDS: dict[str, float | int] = {
    "min_headroom": 0.01,
...
def causal_decision(
    ...
    """Apply the preregistered V16 causal-mechanism decision tree."""

    limits = dict(DEFAULT_CAUSAL_THRESHOLDS)
    limits.update(thresholds)
    for key in DEFAULT_CAUSAL_THRESHOLDS:
    ...
    domain_interaction = _observed_number(
        observed, "domain_interaction", "domain_interaction_gain"
    )
    ...
    gates = {
        ...
        "domain_interaction_passes": abs(domain_interaction)
    ...
    mechanism = {
        ...
        "domain_shift_supported": (
            ...
            and gates["domain_interaction_passes"]
            and common_support
    ...
    elif mechanism["domain_shift_supported"]:
        decision = "DOMAIN_SHIFT_SUPPORTED"
