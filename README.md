...
| RARS-v5 PQ-aware 100K pilot | [Frozen development protocol](docs/rars_v5_pq_aware_100k_pilot_protocol.md) and [machine-readable contract](protocols/rars_v5_pq_aware_100k_pilot_v1.json) define a rank-8 hard-PQ adapter gate with end-to-end, label-independent 100K selection retrieval. No v5 outcome is reported. The 803-query future role remains sealed, and this stage does not authorize RARS combination, a 1M rebuild, or a paper claim. |
